...
export const alt = "NexisHub field guide";
...
export default async function Image({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return new ImageResponse(<div style={{ width: "100%", height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "64px", color: "white", background: `linear-gradient(135deg, hsl(${hue} 72% 15%), #10131c 58%, hsl(${hue + 45} 78% 28%))`, fontFamily: "Arial" }}>
    <div style={{ display: "flex", alignItems: "center", gap: 14, fontSize: 22, letterSpacing: 4, textTransform: "uppercase", color: "#aeb8ff" }}><span style={{ width: 14, height: 14, borderRadius: 99, background: "#6f83ff" }} />NexisHub · {post?.category ?? "Field guide"}</div>
