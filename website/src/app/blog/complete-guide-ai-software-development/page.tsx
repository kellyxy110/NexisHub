    ...
    <div className="shell article-layout">
      ...
      <article className="article-body">
        ...
        <section className="article-references"><h2>External authority references</h2><ol>
          <li><a href="https://developers.openai.com/api/docs/guides/agents">OpenAI Agents docs</a></li><li><a href="https://www.nist.gov/itl/ai-risk-management-framework">NIST AI Risk Management Framework</a></li><li><a href="https://www.nist.gov/itl/ai-risk-management-framework/nist-ai-rmf-playbook">NIST AI RMF Playbook</a></li><li><a href="https://www.anthropic.com/engineering/building-effective-agents">Anthropic, Building effective agents</a></li><li><a href="https://www.anthropic.com/engineering/demystifying-evals-for-ai-agents">Anthropic, Demystifying evals for AI agents</a></li><li><a href="https://genai.owasp.org/llm-top-10/">OWASP Top 10 for LLM and Generative AI Applications</a></li>
        </ol></section>
