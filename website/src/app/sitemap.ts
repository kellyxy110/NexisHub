...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes = ["", "/products", "/products/sitenexis", "/studio", "/about", "/blog", "/research", "/research/ai-visibility-index", "/research/roadmap", "/research/publications", "/research/search", "/contact", "/legal", "/legal/privacy", "/legal/terms", "/legal/cookies"];
