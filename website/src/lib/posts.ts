...
export const blogPosts: readonly BlogPost[] = [
  ...
  visibilityPost({
    ...
    description: "A practical framework for making useful web content crawlable, understandable, retrievable, and citable across AI-assisted discovery systems.",
    targetKeyword: "AI visibility", difficulty: "Intermediate", readingTime: "16 min read",
  ...
  visibilityPost({
    ...
    targetKeyword: "AI visibility vs SEO", difficulty: "Beginner", readingTime: "9 min read",
  ...
  visibilityPost({
    ...
    targetKeyword: "AI website architecture", difficulty: "Advanced", readingTime: "11 min read",
  ...
  visibilityPost({
    ...
    targetKeyword: "internal linking for AI", difficulty: "Intermediate", readingTime: "10 min read",
  ...
  visibilityPost({
    ...
    targetKeyword: "structured data for AI", difficulty: "Advanced", readingTime: "11 min read",
  ...
  visibilityPost({
    ...
    targetKeyword: "entity clarity", difficulty: "Intermediate", readingTime: "10 min read",
  ...
  visibilityPost({
    ...
    targetKeyword: "content structure for AI retrieval", difficulty: "Intermediate", readingTime: "11 min read",
  ...
  visibilityPost({
    ...
    targetKeyword: "citation ready content", difficulty: "Intermediate", readingTime: "10 min read",
  ...
  visibilityPost({
    ...
    targetKeyword: "AI crawlability checklist", difficulty: "Advanced", readingTime: "12 min read",
  ...
  visibilityPost({
    ...
    targetKeyword: "RAG and search", difficulty: "Advanced", readingTime: "12 min read",
  ...
  visibilityPost({
    ...
    targetKeyword: "how AI platforms discover sources", difficulty: "Intermediate", readingTime: "12 min read",
  ...
  visibilityPost({
    ...
    targetKeyword: "measure AI visibility", difficulty: "Advanced", readingTime: "11 min read",
  ...
  visibilityPost({
    ...
    targetKeyword: "content invisible to AI", difficulty: "Intermediate", readingTime: "9 min read",
  ...
  visibilityPost({
    ...
    targetKeyword: "GEO strategy", difficulty: "Intermediate", readingTime: "11 min read",
  ...
  visibilityPost({
    ...
    targetKeyword: "AI visibility roadmap", difficulty: "Beginner", readingTime: "10 min read",
